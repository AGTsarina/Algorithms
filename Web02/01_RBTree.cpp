...
struct Node {
    ...
    void nodeToGraphVis(ofstream &out, int num){
        ...
        out << "I" << num << "[shape=ellipse, color= " << colorName << ", label=\"" << data << "\"];\n";
    }
    static void nullToGraphVis(ofstream &out, int num){
        out << "I" << num << "[shape=ellipse, color=black, label=\"NULL\"];\n";
    }
    void edgeToGraphVis(ofstream &out){
        out << "I" << ID << " -- I" << childrenIDs[0]  <<" [style=bold,color=violet];\n";
        out << "I" << ID << " -- I" << childrenIDs[1] <<"  [style=bold,color=violet];\n";
    }
};
